...
const Transactions = () => {
  ...
  const fetchTransactions = async () => {
    try {
      ...
      const response = await axios.get(`${process.env.EXPO_BACKEND}/api/manufacturer/transactions`, {
        headers: {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container} refreshControl={<RefreshControl refreshing={isRefreshing} onRefresh={onRefresh} colors={['#34D399']} />}>
