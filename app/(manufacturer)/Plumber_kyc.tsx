...
const KYCRequests: React.FC = () => {
    ...
    const fetchRequests = async () => {
        try {
            ...
            if (fetchedToken) {
                const response = await axios.get(`${process.env.EXPO_BACKEND}/api/userkyc/requests`, {
                    headers: {
    ...
    const handleApproval = async (id: string) => {
        try {
            ...
            const response = await axios.post(`${process.env.EXPO_BACKEND}/api/userkyc/approve`, { id }, {
                headers: {
                    Authorization: `Bearer ${fetchedToken}`,
                },
            });
    ...
    const handleRejection = async (id: string, comment: string) => {
        try {
            ...
            const response = await axios.post(`${process.env.EXPO_BACKEND}/api/userkyc/reject`, { id, comment }, {
                headers: {
                    Authorization: `Bearer ${fetchedToken}`,
                },
            });
