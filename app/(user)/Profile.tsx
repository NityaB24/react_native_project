...
const Profile = () => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const response = await axios.get(`${process.env.EXPO_BACKEND}/api/users/profile`, {
        headers: {
  ...
  const handleUpdateProfile = async () => {
    try {
      ...
      const response = await axios.put(`${process.env.EXPO_BACKEND}/api/users/profile`, payload, {
        headers: {
          Authorization: `Bearer ${token}`,
