...
const UserRedemptionRequest = () => {
    ...
    const fetchRequests = async () => {
        try {
            ...
            const response = await axios.get('http://192.168.29.101:3000/api/manufacturer/users/all-requests', {
                headers: {
            ...
            async (couponCode) => {
                ...
                try {
                    ...
                    const response = await axios.post(
                        'http://192.168.29.101:3000/api/manufacturer/user-approve-redemption',
                        {
