...
const KYCRequests: React.FC = () => {
    ...
    const fetchRequests = async () => {
        try {
            ...
            if (fetchedToken) {
                const response = await axios.get('http://192.168.29.101:3000/api/kyc/requests', {
                    headers: {
    ...
    const handleApproval = async (id: string) => {
        try {
            ...
            const response = await axios.post('http://192.168.29.101:3000/api/kyc/approve', { id }, {
                headers: {
                    Authorization: `Bearer ${fetchedToken}`,
                },
            });
    ...
    const handleRejection = async (id: string, comment: string) => {
        try {
            ...
            const response = await axios.post('http://192.168.29.101:3000/api/kyc/reject', { id, comment }, {
                headers: {
                    Authorization: `Bearer ${fetchedToken}`,
                },
            });
