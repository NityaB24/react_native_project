  ...
  const closeDrawer = () => {
    ...
    const redeemPoints = async (points:number, method:string) => {
        try {
            ...
            setError(null);
            // Show alert with redemption details
            Alert.alert(
    ...
    const redemptionOptions = [
        { method: 'amazon', points: 1000, image: require('@/app/images/Booking.png') },
        { method: 'google', points: 500, image: require('@/app/images/Booking.png') },
        { method: 'Xbox', points: 300, image: require('@/app/images/Booking.png') }
    ];
